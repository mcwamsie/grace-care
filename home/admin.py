...
class AssemblyAdmin(admin.ModelAdmin):
    list_display = ('name', 'church', 'location')
    list_filter = ('church',)
...
class MemberAdmin(UserAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'phone_number', 'assembly', 'is_staff', 'is_active')
    list_filter = ('assembly', 'is_staff', 'is_active')
